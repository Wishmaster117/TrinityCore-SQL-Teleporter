...
-- , modelid1 = , @MODEL
-- , gossip_menu_id = , @GOSSIP_MENU
-- , minlevel, maxlevel = , 71, 71
-- , `rank` =  1,
-- , type_flags = , 138936390
...
(15, @GOSSIP_MENU+10, 3, 27, 77, 3, 0, "Portal Master - Level req"),
(15, @GOSSIP_MENU+10, 2, 27, 77, 3, 0, "Portal Master - Level req"),
(15, @GOSSIP_MENU+10, 1, 27, 77, 3, 0, "Portal Master - Level req"),
(15, @GOSSIP_MENU+10, 0, 27, 77, 3, 0, "Portal Master - Level req"),
-- Pandaria
...
(15, @GOSSIP_MENU+15, 5, 27, 77, 3, 0, "Portal Master - Level req"),
(15, @GOSSIP_MENU+15, 4, 27, 77, 3, 0, "Portal Master - Level req"),
(15, @GOSSIP_MENU+15, 3, 27, 77, 3, 0, "Portal Master - Level req"),
...
-- Ajout The War Within
(@GOSSIP_MENU+10, 0, NULL, "Dornogal", 0, 0, 0, 0, "Are you sure, that you want to go to Dornogal?"),
(@GOSSIP_MENU+10, 1, NULL, "The War Within", 0, 0, 0, 0, "Are you sure, that you want to go to The War Within?"),
(@GOSSIP_MENU+10, 2, NULL, "The War Within", 0, 0, 0, 0, "Are you sure, that you want to go to The War Within?"),
(@GOSSIP_MENU+10, 3, NULL, "The War Within", 0, 0, 0, 0, "Are you sure, that you want to go to The War Within?"),
...
(@GOSSIP_MENU+15, 3, NULL, "Shadowlands", 0, 0, 0, 0, "Are you sure, that you want to go to Shadowlands?"),
(@GOSSIP_MENU+15, 4, NULL, "Shadowlands", 0, 0, 0, 0, "Are you sure, that you want to go to Shadowlands?"),
(@GOSSIP_MENU+15, 5, NULL, "Shadowlands", 0, 0, 0, 0, "Are you sure, that you want to go to Shadowlands?"),
...
(@ENTRY, 0, 135, 0, 62, 0, 100, 0, @GOSSIP_MENU+10, 3, 0, 0, 62, 571, 0, 0, 0, 0, 0, 7, 0, 0, 0, 4017.35, -3403.85, 290, 5.35431, "Zone 4"),
...
(@ENTRY, 0, 185, 0, 62, 0, 100, 0, @GOSSIP_MENU+15, 3, 0, 0, 62, 571, 0, 0, 0, 0, 0, 7, 0, 0, 0, 4017.35, -3403.85, 290, 5.35431, "Zone 4"),
(@ENTRY, 0, 186, 0, 62, 0, 100, 0, @GOSSIP_MENU+15, 4, 0, 0, 62, 571, 0, 0, 0, 0, 0, 7, 0, 0, 0, 5560.23, -3211.66, 371.709, 5.55055, "Zone 5"),
(@ENTRY, 0, 187, 0, 62, 0, 100, 0, @GOSSIP_MENU+15, 5, 0, 0, 62, 571, 0, 0, 0, 0, 0, 7, 0, 0, 0, 5614.67, 5818.86, -69.722, 3.60807, "Zone 6"),
(@ENTRY, 0, 188, 0, 62, 0, 100, 0, @GOSSIP_MENU+15, 6, 0, 0, 62, 571, 0, 0, 0, 0, 0, 7, 0, 0, 0, 5411.17, -966.37, 167.082, 1.57167, "Zone 7"),
