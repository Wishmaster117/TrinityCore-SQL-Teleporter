...
-- Ajout The War Within
(@GOSSIP_MENU+10, 0, NULL, "Dornogal (Dorn Island)", 0, 0, 0, 0, "Are you sure, that you want to go to Dornogal?"),
(@GOSSIP_MENU+10, 1, NULL, "The War Within (Abîmes Retentissants)", 0, 0, 0, 0, "Are you sure, that you want to go to The War Within?"),
(@GOSSIP_MENU+10, 2, NULL, "The War Within (Sainte-Chute)", 0, 0, 0, 0, "Are you sure, that you want to go to The War Within?"),
(@GOSSIP_MENU+10, 3, NULL, "The War Within(Azj-Kahet)", 0, 0, 0, 0, "Are you sure, that you want to go to The War Within?"),
