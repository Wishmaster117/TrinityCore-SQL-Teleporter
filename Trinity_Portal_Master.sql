...
(15, @GOSSIP_MENU+3, 10, 27, 10, 3, 0, "Portal Master - Level req Utgarde Keep"),
(15, @GOSSIP_MENU+3, 9, 27, 20, 3, 0, "Portal Master - Level req Halls of Stone"),
(15, @GOSSIP_MENU+3, 8, 27, 10, 3, 0, "Portal Master - Level req Halls of Lightning"),
(15, @GOSSIP_MENU+3, 7, 27, 10, 3, 0, "Portal Master - Level req The Violet Hold"),
(15, @GOSSIP_MENU+3, 6, 27, 10, 3, 0, "Portal Master - Level req The Nexus Dungeons"),
...
(15, @GOSSIP_MENU+3, 3, 27, 15, 3, 0, "Portal Master - Level req Drak'Tharon Keep"),
...
(15, @GOSSIP_MENU+12, 6, 27, 77, 3, 0, "Portal Master - Level req"),
(15, @GOSSIP_MENU+12, 5, 27, 77, 3, 0, "Portal Master - Level req"),
(15, @GOSSIP_MENU+12, 4, 27, 77, 3, 0, "Portal Master - Level req"),
(15, @GOSSIP_MENU+12, 3, 27, 77, 3, 0, "Portal Master - Level req"),
...
(15, @GOSSIP_MENU+13, 6, 27, 77, 3, 0, "Portal Master - Level req"),
(15, @GOSSIP_MENU+13, 5, 27, 77, 3, 0, "Portal Master - Level req"),
(15, @GOSSIP_MENU+13, 4, 27, 77, 3, 0, "Portal Master - Level req"),
(15, @GOSSIP_MENU+13, 3, 27, 77, 3, 0, "Portal Master - Level req"),
...
(15, @GOSSIP_MENU+14, 6, 27, 77, 3, 0, "Portal Master - Level req"),
(15, @GOSSIP_MENU+14, 5, 27, 77, 3, 0, "Portal Master - Level req"),
(15, @GOSSIP_MENU+14, 4, 27, 77, 3, 0, "Portal Master - Level req"),
(15, @GOSSIP_MENU+14, 3, 27, 77, 3, 0, "Portal Master - Level req"),
...
(@GOSSIP_MENU+12, 3, NULL, "Draenor", 0, 0, 0, 0, "Are you sure, that you want to go to Draenor?"),
(@GOSSIP_MENU+12, 4, NULL, "Draenor", 0, 0, 0, 0, "Are you sure, that you want to go to Draenor?"),
(@GOSSIP_MENU+12, 5, NULL, "Draenor", 0, 0, 0, 0, "Are you sure, that you want to go to Draenor?"),
(@GOSSIP_MENU+12, 6, NULL, "Draenor", 0, 0, 0, 0, "Are you sure, that you want to go to Draenor?"),
...
(@GOSSIP_MENU+13, 3, NULL, "Legion", 0, 0, 0, 0, "Are you sure, that you want to go to Legion?"),
(@GOSSIP_MENU+13, 4, NULL, "Legion", 0, 0, 0, 0, "Are you sure, that you want to go to Legion?"),
(@GOSSIP_MENU+13, 5, NULL, "Legion", 0, 0, 0, 0, "Are you sure, that you want to go to Legion?"),
(@GOSSIP_MENU+13, 6, NULL, "Legion", 0, 0, 0, 0, "Are you sure, that you want to go to Legion?"),
...
(@GOSSIP_MENU+14, 3, NULL, "BFA", 0, 0, 0, 0, "Are you sure, that you want to go to BFA?"),
(@GOSSIP_MENU+14, 4, NULL, "BFA", 0, 0, 0, 0, "Are you sure, that you want to go to BFA?"),
(@GOSSIP_MENU+14, 5, NULL, "BFA", 0, 0, 0, 0, "Are you sure, that you want to go to BFA?"),
(@GOSSIP_MENU+14, 6, NULL, "BFA", 0, 0, 0, 0, "Are you sure, that you want to go to BFA?"),
...
(@ENTRY, 0, 155, 0, 62, 0, 100, 0, @GOSSIP_MENU+12, 3, 0, 0, 62, 571, 0, 0, 0, 0, 0, 7, 0, 0, 0, 4017.35, -3403.85, 290, 5.35431, "Zone 4"),
(@ENTRY, 0, 156, 0, 62, 0, 100, 0, @GOSSIP_MENU+12, 4, 0, 0, 62, 571, 0, 0, 0, 0, 0, 7, 0, 0, 0, 5560.23, -3211.66, 371.709, 5.55055, "Zone 5"),
(@ENTRY, 0, 157, 0, 62, 0, 100, 0, @GOSSIP_MENU+12, 5, 0, 0, 62, 571, 0, 0, 0, 0, 0, 7, 0, 0, 0, 5614.67, 5818.86, -69.722, 3.60807, "Zone 6"),
(@ENTRY, 0, 158, 0, 62, 0, 100, 0, @GOSSIP_MENU+12, 6, 0, 0, 62, 571, 0, 0, 0, 0, 0, 7, 0, 0, 0, 5411.17, -966.37, 167.082, 1.57167, "Zone 7"),
...
(@ENTRY, 0, 165, 0, 62, 0, 100, 0, @GOSSIP_MENU+13, 3, 0, 0, 62, 571, 0, 0, 0, 0, 0, 7, 0, 0, 0, 4017.35, -3403.85, 290, 5.35431, "Zone 4"),
(@ENTRY, 0, 166, 0, 62, 0, 100, 0, @GOSSIP_MENU+13, 4, 0, 0, 62, 571, 0, 0, 0, 0, 0, 7, 0, 0, 0, 5560.23, -3211.66, 371.709, 5.55055, "Zone 5"),
(@ENTRY, 0, 167, 0, 62, 0, 100, 0, @GOSSIP_MENU+13, 5, 0, 0, 62, 571, 0, 0, 0, 0, 0, 7, 0, 0, 0, 5614.67, 5818.86, -69.722, 3.60807, "Zone 6"),
(@ENTRY, 0, 168, 0, 62, 0, 100, 0, @GOSSIP_MENU+13, 6, 0, 0, 62, 571, 0, 0, 0, 0, 0, 7, 0, 0, 0, 5411.17, -966.37, 167.082, 1.57167, "Zone 7"),
...
(@ENTRY, 0, 175, 0, 62, 0, 100, 0, @GOSSIP_MENU+14, 3, 0, 0, 62, 571, 0, 0, 0, 0, 0, 7, 0, 0, 0, 4017.35, -3403.85, 290, 5.35431, "Zone 4"),
(@ENTRY, 0, 176, 0, 62, 0, 100, 0, @GOSSIP_MENU+14, 4, 0, 0, 62, 571, 0, 0, 0, 0, 0, 7, 0, 0, 0, 5560.23, -3211.66, 371.709, 5.55055, "Zone 5"),
(@ENTRY, 0, 177, 0, 62, 0, 100, 0, @GOSSIP_MENU+14, 5, 0, 0, 62, 571, 0, 0, 0, 0, 0, 7, 0, 0, 0, 5614.67, 5818.86, -69.722, 3.60807, "Zone 6"),
(@ENTRY, 0, 178, 0, 62, 0, 100, 0, @GOSSIP_MENU+14, 6, 0, 0, 62, 571, 0, 0, 0, 0, 0, 7, 0, 0, 0, 5411.17, -966.37, 167.082, 1.57167, "Zone 7"),
...
-- Shadowlands
(@ENTRY, 0, 182, 0, 62, 0, 100, 0, @GOSSIP_MENU+15, 0, 0, 0, 62, 2222, 0, 0, 0, 0, 0, 7, 0, 0, 0, -1834.00, 1542.00, 5274.156250, 4.71239, "Oribos"),
(@ENTRY, 0, 183, 0, 62, 0, 100, 0, @GOSSIP_MENU+15, 1, 0, 0, 62, 2222, 0, 0, 0, 0, 0, 7, 0, 0, 0, 2585.715088, -2525.375488, 3307.614502, 5.431034, "Maldraxxus"),
(@ENTRY, 0, 184, 0, 62, 0, 100, 0, @GOSSIP_MENU+15, 2, 0, 0, 62, 2222, 0, 0, 0, 0, 0, 7, 0, 0, 0, -2943.555664, -4871.619629, 6704.122559, 1.531532, "Bastion"),
