...
(15, @GOSSIP_MENU+4, 22, 27, 70, 3, 0, "Portal Master - Level req Zul'Aman"),
(15, @GOSSIP_MENU+4, 21, 27, 57, 3, 0, "Portal Master - Level req Zul'Gurub"),
(15, @GOSSIP_MENU+4, 19, 27, 80, 3, 0, "Portal Master - Level req Vault of Archavon"),
(15, @GOSSIP_MENU+4, 18, 27, 80, 3, 0, "Portal Master - Level req Ulduar"),
(15, @GOSSIP_MENU+4, 17, 27, 80, 3, 0, "Portal Master - Level req The Obsidian Sanctum"),
(15, @GOSSIP_MENU+4, 16, 27, 80, 3, 0, "Portal Master - Level req The Eye of Eternity"),
(15, @GOSSIP_MENU+4, 15, 27, 60, 3, 0, "Portal Master - Level req Temple of Ahn'Qiraj"),
(15, @GOSSIP_MENU+4, 14, 27, 67, 3, 0, "Portal Master - Level req The Eye"),
(15, @GOSSIP_MENU+4, 13, 27, 70, 3, 0, "Portal Master - Level req Sunwell Plateau"),
(15, @GOSSIP_MENU+4, 12, 27, 60, 3, 0, "Portal Master - Level req Ruins of Ahn'Qiraj"),
(15, @GOSSIP_MENU+4, 11, 27, 80, 3, 0, "Portal Master - Level req Onyxia's Lair"),
(15, @GOSSIP_MENU+4, 10, 27, 80, 3, 0, "Portal Master - Level req Naxxramas"),
(15, @GOSSIP_MENU+4, 9, 27, 60, 3, 0, "Portal Master - Level req Molten Core"),
(15, @GOSSIP_MENU+4, 8, 27, 70, 3, 0, "Portal Master - Level req Karazhan"),
(15, @GOSSIP_MENU+4, 7, 27, 80, 3, 0, "Portal Master - Level req Icecrown Citadel"),
(15, @GOSSIP_MENU+4, 6, 27, 70, 3, 0, "Portal Master - Level req Magtheridon's Lair"),
(15, @GOSSIP_MENU+4, 5, 27, 70, 3, 0, "Portal Master - Level req Gruul's Lair"),
(15, @GOSSIP_MENU+4, 4, 27, 80, 3, 0, "Portal Master - Level req Trial of the Crusader"),
(15, @GOSSIP_MENU+4, 3, 27, 70, 3, 0, "Portal Master - Level req Serpentshrine Cavern"),
(15, @GOSSIP_MENU+4, 2, 27, 70, 3, 0, "Portal Master - Level req Hyjal Summit"),
(15, @GOSSIP_MENU+4, 1, 27, 60, 3, 0, "Portal Master - Level req Blackwing Lair"),
(15, @GOSSIP_MENU+4, 0, 27, 70, 3, 0, "Portal Master - Level req Black Temple"),
...
(15, @GOSSIP_MENU+2, 5, 27, 70, 3, 0, "Portal Master - Level req Tempest Keep"),
(15, @GOSSIP_MENU+2, 4, 27, 70, 3, 0, "Portal Master - Level req Magisters' Terrace"),
(15, @GOSSIP_MENU+2, 3, 27, 59, 3, 0, "Portal Master - Level req Hellfire Citadel"),
(15, @GOSSIP_MENU+2, 2, 27, 62, 3, 0, "Portal Master - Level req Coilfang Reservoir"),
(15, @GOSSIP_MENU+2, 1, 27, 66, 3, 0, "Portal Master - Level req Caverns of Time"),
(15, @GOSSIP_MENU+2, 0, 27, 64, 3, 0, "Portal Master - Level req Auchindoun"),
-- Classic Dungeons level restriction
(15, @GOSSIP_MENU+1, 18, 27, 35, 3, 0, "Portal Master - Level req Zul'Farrak"),
(15, @GOSSIP_MENU+1, 17, 27, 37, 3, 0, "Portal Master - Level req Uldaman"),
(15, @GOSSIP_MENU+1, 16, 27, 47, 3, 0, "Portal Master - Level req Sunken Temple"),
(15, @GOSSIP_MENU+1, 15, 27, 55, 3, 0, "Portal Master - Level req Stratholme"),
(15, @GOSSIP_MENU+1, 14, 27, 55, 3, 0, "Portal Master - Level req Scholomance"),
(15, @GOSSIP_MENU+1, 13, 27, 45, 3, 0, "Portal Master - Level req Maraudon"),
(15, @GOSSIP_MENU+1, 12, 27, 55, 3, 0, "Portal Master - Level req Dire Maul"),
(15, @GOSSIP_MENU+1, 11, 27, 57, 3, 0, "Portal Master - Level req Blackrock Spire"),
(15, @GOSSIP_MENU+1, 10, 27, 53, 3, 0, "Portal Master - Level req Blackrock Depths"),
(15, @GOSSIP_MENU+1, 9, 27, 21, 3, 0, "Portal Master - Level req Blackfathom Deeps"),
(15, @GOSSIP_MENU+1, 8, 27, 17, 3, 0, "Portal Master - Level req Wailing Caverns"),
(15, @GOSSIP_MENU+1, 7, 27, 18, 3, 0, "Portal Master - Level req Shadowfang Keep"),
(15, @GOSSIP_MENU+1, 6, 27, 32, 3, 0, "Portal Master - Level req Scarlet Monastery"),
(15, @GOSSIP_MENU+1, 5, 27, 24, 3, 0, "Portal Master - Level req Razorfen Kraul"),
(15, @GOSSIP_MENU+1, 4, 27, 34, 3, 0, "Portal Master - Level req Razorfen Downs"),
(15, @GOSSIP_MENU+1, 3, 27, 15, 3, 0, "Portal Master - Level req Ragefire Chasm"),
(15, @GOSSIP_MENU+1, 2, 27, 22, 3, 0, "Portal Master - Level req The Stockade"),
(15, @GOSSIP_MENU+1, 1, 27, 17, 3, 0, "Portal Master - Level req The Deadmines"),
(15, @GOSSIP_MENU+1, 0, 27, 25, 3, 0, "Portal Master - Level req Gnomeregan"),
...
(15, @GOSSIP_MENU, 20, 27, 57, 3, 0, "Portal Master - Level req Raid Teleports"),
(15, @GOSSIP_MENU, 19, 27, 69, 3, 0, "Portal Master - Level req Wrath Dungeons"),
(15, @GOSSIP_MENU, 18, 27, 59, 3, 0, "Portal Master - Level req BC Dungeons"),
(15, @GOSSIP_MENU, 17, 27, 15, 3, 0, "Portal Master - Level req Classic Dungeons"),
...
(@GOSSIP_MENU, 20, NULL, "Raid Teleports", @GOSSIP_MENU+4, 0, 0, 0, NULL),
